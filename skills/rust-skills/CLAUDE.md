...
- [`async-join-parallel`](rules/async-join-parallel.md) - Use tokio join macro for parallel operations
- [`async-try-join`](rules/async-try-join.md) - Use tokio try_join macro for fallible parallel ops
- [`async-select-racing`](rules/async-select-racing.md) - Use tokio select macro for racing/timeouts
...
- [`type-never-diverge`](rules/type-never-diverge.md) - Use the never type for functions that don't return
...
- [`doc-module-inner`](rules/doc-module-inner.md) - Use inner doc comments for module-level documentation
